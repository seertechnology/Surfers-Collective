    ...
    <main className={styles.main}>
      ...
      <div className={styles.background}>
        ...
        {/* nav */}
          ...
          <h1 className={styles.titleTitleText}>Book Now</h1>          
        </div>
            </div>
        ...
        <div className='container'>
          <div className='row pt-5 pb-5'>
            <div className='col-md-6'>
              <Image src={singleImage} width={549} height={330.66} className={styles.sectionImage} alt=""></Image>
            </div>
            <div className='col-md-6'>
              <div >
      ...
      <div className={styles.weldingBg} ref={pushRef}>
        <div className='container'>
          ...
          <div className='col-md-6'>
            ...
            <div className='col-md-6'>
              <Image src={coupleImage} width={549} height={330.66} className={styles.sectionImage} alt=""></Image>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.weldingBg} ref={pushRef}>
        <div className='container'>
          <div className='row pt-5  pb-5'>
            <div className='col-md-6'>
              <Image src={familyImage} width={549} height={411.93} className={styles.sectionImage} alt=""></Image>
            </div>
            <div className='col-md-6'>
              <div >
