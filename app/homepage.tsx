        ...
        <div className={styles.background} style={mobileNav ? {background: "none", height: "0px"} : {}}>
          ...
          <div className={styles.navbarSection}>
            {/* <div className='container'> */}
              <nav className={mobileNav ? "navbar navbar-expand-xl navbar-dark" : "navbar navbar-expand-xl navbar-dark p-4"} style={mobileNav ? {backgroundColor: '#116C89'} : {backgroundColor: ''}}>
