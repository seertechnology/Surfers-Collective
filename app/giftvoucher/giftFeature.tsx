              ...
              <div className='row pt-5 pb-5'>
                ...
                <div className='col-md-6'>
                  <div >
                      ...
                      <a href='https://web-31p.bookeo.com/bookeo/settings-settingsColorsCustomers.html?mode=layout&ncs=yp9fk3anrw'><button type='button' className={styles.bookSectionButton}>Book Now</button></a>
                  </div>
                </div>
              </div>
            </div>
