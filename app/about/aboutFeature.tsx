            ...
            <div className='container'>
              <div className='row pt-5 pb-5'>
                <div className='col-md-6'>
                  ...
                  <Image src={singleImage} width={542} height={566} className={styles.sectionImage} alt="" style={{maxWidth: "105%"}}></Image>
                </div>
                <div className='col-md-6'>
            ...
            <div className='container'>
              <div className='row pt-5 pb-5'>
                ...
                <h1 className={styles.servicesTitle} style={{textAlign:"center"}}>Cancellation Policy</h1>
                    <Image src={coupleImage} width={536} height={405} className={styles.sectionImage} alt="" style={{maxWidth: "100%"}}></Image>
                </div>
                <div className='col-md-6'>
                  <div >
            ...
            <div className='container'>
              <div className='row pt-5  pb-5'>
                <div className='col-md-6'>
                  ...
                  <Image src={familyImage} width={548} height={330} className={styles.sectionImage} alt="" style={{maxWidth: "100%"}}></Image>
                </div>
                <div className='col-md-6'>
